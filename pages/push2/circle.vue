    ...
    <view class="moments__post"
      ...
      <view class="post_right">
        ...
        <view class="toolbar">
		  ...
		  <view v-show="post.is_my_circle == 1"
		   style="color: #0A98D5;" @tap="delCircle(post.post_id)" >删除</view>
		  </view>
...
export default {
  ...
  onLoad (option) {
    let _this = this;
	_this.my_user_id = option.user_id;
  ...
  onShow () {
    ...
    uni.$on('data_user_info', function (data) {
      _this.my_data = data;
	  _this.my_user_id = _this.my_data.id;
	   console.log("用户个人数据：",_this.my_data.id);
    });
