      ...
      <view class="gong-gao-content" v-if="msgList.type == 1">
		...
		<view class="gong-gao-content-info" v-if="1">
          ...
          <text-scroll :text="notice" ref="scrollNotice"></text-scroll>
				...
				<!--<view class="member-image-logo">-->
				<!--<image src="http://demo70.zhigou888.com/static/photo/default_man/300.jpg"></image>-->
				<!--</view>-->
			</view>
...
<script>
	...
	export default {
		...
		onShow() {
			...
			console.log("我的昵称",_this.my_data.nickname)
		...
		methods: {
				...
				this.$httpSend({
					...
					success(res) {
						...
						if (res.err === 0) {
							...
							res.data.myname = _this.my_data.nickname;
			...
			getVideo(data) {
				...
				_this.myName = data.myname;
				_this.myAvatar = data.myavatar;
				console.log("我的头像",_this.myAvatar)
				
				//设置腾讯云音视频昵称
				TUICalling.setUserNickname({
				    nickName: _this.myName
				},(res) => {
				    console.log(JSON.stringify(res))
					//设置腾讯云音视频头像
					TUICalling.setUserAvatar({
					    avatar: _this.myAvatar
					},(res) => {
					    console.log(JSON.stringify(res))
