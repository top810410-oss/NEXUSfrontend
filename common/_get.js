...
export default {
   ...
   /**
	...
	addUserAlipay(params,callback){
		_mixins.methods.$httpSend({
			path: '/im/get/addUserAlipay',
			data: params,
			success (fireParams) {
	...
	getTabbarFindInfo(params,callback){
		_mixins.methods.$httpSend({
			path: '/im/tabbarFind/getTabbarFindUrl',
			data: params,
			success (ret) {
				if(callback){
					callback(ret);
	...
	getAnnouncementInfo(params,callback){
		_mixins.methods.$httpSend({
			path: '/im/announcement/getAnnounceMentInfo',
			data: params,
			success (ret) {
				if(callback){
					callback(ret);
	...
	signDay(params,callback){
		_mixins.methods.$httpSend({
			path: '/im/sign/updateSignData',
			data: params,
			success (ret) {
				if(callback){
					callback(ret);
	...
	getDbSysConfig(params,callback,fail_callback){
	    _mixins.methods.$httpSend({
	        path: '/im/App/sysConfig',
	        data: params,
	        success (ret) {
	            if(callback){
	                callback(ret);
	...
	getClientIp(params,callback,fail_callback){
	    _mixins.methods.$httpSend({
	        path: '/im/app/getClientip',
	        success (ret) {
	            if(callback){
	                callback(ret);
	            }
	...
	getVideoAppId(params,callback){
		_mixins.methods.$httpSend({
			path: '/im/get/getVideoAppId',
			data: params,
			success (ret) {
				if(callback){
					callback(ret);
	...
	getUserVideoSign(params,callback){
		_mixins.methods.$httpSend({
			path: '/im/get/getUserVideoSign',
			data: params,
			success (ret) {
				if(callback){
					callback(ret);
	...
	delCircle(params,callback){
		_mixins.methods.$httpSend({
			path: '/im/action/delCircle',
			data: params,
			success (ret) {
				if(callback){
					callback(ret);
	...
	getUserNickname(params,callback){
		_mixins.methods.$httpSend({
			path: '/im/get/getUserNickname',
			data: params,
			success (ret) {
				if(callback){
					callback(ret);
