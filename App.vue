<script>
    ...
    export default {
        globalData: {
            ...
            http_url: 'http://app.pamd.cn',
        
            /** 静态文件存放地址 */
			
			 static_url: 'http://app.pamd.cn',
          
            /** socket 服务端地址 */
			
            socket_url: 'ws://app.pamd.cn:8383',
        ...
        onLaunch() {
			...
			plus.globalEvent.addEventListener('FileChooseResult', (e) => {
				...
				//文件大小
				if(e.fileType == "jpg" || e.fileType == "jpeg" || e.fileType == "gif" || e.fileType == "png" || e.fileType == "bmp" || e.fileType == "webp" || e.fileType == "pjpej")
				{
					filetype = 2;
				}
				else if(e.fileType == "mp4" || e.fileType == "mov")
				{
					filetype = 4;
				}
				this.globalData.filemsg = {
					url: filePath,
					filetype:e.fileType,
					filename:e.fileName
				};
				this.globalData.filesendtype = filetype;
			    /*
				var msg = {
					url: filePath,
					filetype:e.fileType,
				...
				console.log("777777777777-------------------777777777777777777777");
				console.log(e);
				this.sendMsg(msg, filetype);
				*/
